...
class SBPPISDataset(Dataset):
    def __init__(self, file_path, transforms, heatmap_generator, ratio, class_labels, num_keypoints):
        super().__init__()
...
class SBPPISDataModule(pl.LightningDataModule):
    def __init__(
        self, 
        train_path, 
        val_path,
    ...
    def setup(self, stage=None):
        ...
        self.train_dataset = SBPPISDataset(
            self.train_path,
            train_transforms, 
        ...
        self.valid_dataset = SBPPISDataset(
            self.val_path,
            valid_transform, 
            self.heatmap_generator,
            self.ratio,
...
if __name__ == '__main__':
    ...
    map_metric = SBPmAPPIS(cfg['val_path'], cfg['input_size'], cfg['conf_threshold'])
