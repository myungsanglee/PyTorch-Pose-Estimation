...
from utils.sbp_utils import SBPHeatmapGenerator, DecodeSBP, SBPmAPCOCO
from utils.yaml_helper import get_configs


class SBPCOCODataset(Dataset):
...
class SBPCOCODataModule(pl.LightningDataModule):
    def __init__(
        self, 
        train_path, 
        val_path,
    ...
    def setup(self, stage=None):
        ...
        self.train_dataset = SBPCOCODataset(
            self.img_dir,
            self.train_path,
            train_transforms, 
        ...
        self.valid_dataset = SBPCOCODataset(
            self.img_dir,
            self.val_path,
            valid_transform, 
            self.heatmap_generator,
