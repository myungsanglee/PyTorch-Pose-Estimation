...
class SBPPISDetector(pl.LightningModule):
    def __init__(self, model, cfg):
        super().__init__()
        self.save_hyperparameters(ignore='model')
        self.model = model
        self.loss_fn = SBPLoss()
        self.map_metric = SBPmAPPIS(cfg['val_path'], cfg['input_size'], cfg['conf_threshold'])
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('train_loss', loss, prog_bar=True, logger=True, batch_size=img.size(0))
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('val_loss', loss, prog_bar=True, logger=True, batch_size=img.size(0))
